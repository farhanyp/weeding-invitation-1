export default function Home() {
  return (
    <main className="bg-surface text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Portrait Maya dan Alex di ruang galeri modern"
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 animate-bounce text-3xl text-primary">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 md:grid-cols-2">
          <div className="relative">
            <div className="aspect-[3/4] overflow-hidden rounded-xl shadow-2xl">
              <img
                ...
                alt="Maya dan Alex berpegangan tangan"
            ...
            <div className="-z-10 absolute -right-8 -bottom-8 h-48 w-48 rounded-xl bg-secondary-container" />
          </div>
          <div className="space-y-8">
            ...
            <p className="text-lg leading-relaxed text-on-surface-variant">
              Dimulai dari sebuah pertemuan singkat di perpustakaan kota, hingga
              perjalanan panjang melintasi benua. Kami menemukan bahwa rumah
              bukanlah sebuah tempat, melainkan satu sama lain.
            </p>
            <p className="text-lg leading-relaxed text-on-surface-variant">
              Tiga tahun berlalu, penuh dengan tawa, tantangan, dan ribuan
              cangkir kopi. Hari ini, kami mengundang Anda untuk menjadi saksi
              awal dari bab baru kehidupan kami.
            </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center rounded-xl bg-surface-container-lowest p-10 text-center shadow-sm transition-transform hover:-translate-y-2">
              <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-primary-container text-3xl text-primary">
                ❤
              </div>
            ...
            <div className="flex flex-col items-center rounded-xl bg-primary p-10 text-center text-on-primary shadow-xl transition-transform hover:-translate-y-2">
              <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-on-primary text-3xl text-primary">
                ✦
              </div>
            ...
            <div className="flex flex-col items-center rounded-xl bg-surface-container-lowest p-10 text-center shadow-sm transition-transform hover:-translate-y-2">
              <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-tertiary-container text-3xl text-tertiary">
                ⌖
              </div>
              <h3 className="mb-4 font-headline text-3xl italic text-primary">
                Lokasi
              ...
              <a
                className="rounded-full bg-tertiary px-6 py-3 text-sm font-bold uppercase tracking-widest text-on-tertiary hover:opacity-90"
                href="#"
              >
                Buka Google Maps
              </a>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex items-end justify-between">
            <div>
              ...
              <p className="mt-2 italic text-on-surface-variant">
                Capture in time, frozen in love.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
            ...
            <div className="group aspect-square translate-y-8 overflow-hidden rounded-xl">
              <img
                className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"
                alt="Cincin pernikahan di kain renda"
            ...
            <div className="group aspect-square overflow-hidden rounded-xl">
              <img
                className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"
                alt="Maya dan Alex tertawa bersama"
            ...
            <div className="group aspect-square translate-y-8 overflow-hidden rounded-xl">
              <img
                className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"
                alt="Dekorasi meja resepsi pernikahan"
          ...
          <div className="mt-16 text-center md:hidden">
            <button className="border-b-2 border-primary-container pb-1 font-label text-sm font-bold uppercase tracking-widest text-primary">
              Lihat Semua Foto
            </button>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-md text-on-surface-variant">
              ...
              memberikan tanda kasih, Anda dapat melakukannya secara digital.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-16 overflow-hidden rounded-[2rem] bg-primary shadow-2xl">
            <div className="flex flex-col md:flex-row">
              <div className="relative h-48 md:h-auto md:w-1/3">
                <img
                  className="h-full w-full object-cover"
                  alt="Undangan pernikahan artistik"
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="max-w-lg rounded-2xl rounded-tl-none bg-surface-container-lowest p-6 shadow-sm">
                <p className="leading-relaxed text-on-surface">
                  Selamat ya Maya &amp; Alex! Semoga lancar sampai hari H dan jadi
                  keluarga yang sakinah. Cannot wait for the big day!
                </p>
            ...
            <div className="flex flex-row-reverse gap-4">
              ...
              <div className="max-w-lg rounded-2xl rounded-tr-none bg-primary p-6 text-on-primary shadow-md">
                <p className="leading-relaxed">
                  Wishing you both a lifetime of happiness. Truly an inspiration
                  to us all. See you guys soon!
                </p>
            ...
            <div className="flex gap-4">
              ...
              <div className="max-w-lg rounded-2xl rounded-tl-none bg-surface-container-lowest p-6 shadow-sm">
                <p className="leading-relaxed text-on-surface">
                  Akhirnya kapal ini berlabuh juga. Bahagia selalu ya kalian
                  berdua!
                </p>
                <span className="mt-4 block text-[10px] uppercase tracking-widest text-outline-variant">
                  Linda - Kemarin
